const logger = require('pomelo-logger').getLogger('pomelo-rpc', 'MailStation');
const EventEmitter = require('events').EventEmitter;
const blackhole = require('./mailboxes/blackhole');
...
const pro = MailStation.prototype;
...
pro.dispatch = function(tracer, serverId, msg, opts, cb)
{
	...
	const send = function(tracer, err, serverId, msg, opts)
	{
 ...
 */
const doFilter = function(tracer, err, serverId, msg, opts, filters, index, operate, cb)
{
...
const lazyConnect = function(tracer, station, serverId, factory, cb)
{
...
const addToPending = function(tracer, station, serverId, args)
{
...
const flushPending = function(tracer, station, serverId, cb)
{
...
const errorHandler = function(tracer, station, err, serverId, msg, opts, flag, cb)
{
