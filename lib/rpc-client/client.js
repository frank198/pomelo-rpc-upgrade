const logger = require('pomelo-logger').getLogger('pomelo-rpc', 'rpc-client');
 ...
 * @api private
 */
const createStation = function(opts)
{
 ...
 * @api private
 */
const generateProxy = function(client, record, context)
{
	if (!record)
	{
		return;
 ...
 * @api private
 */
const proxyCB = function(client, serviceName, methodName, args, attach, isToSpecifiedServer)
{
 ...
 * @api private
 */
const getRouteTarget = function(client, serverType, msg, routeParam, cb)
{
 ...
 * @api private
 */
const rpcToSpecifiedServer = function(client, msg, serverType, serverId, cb)
{
 ...
 * @api private
 */
const insertProxy = function(proxies, namespace, serverType, proxy)
{
